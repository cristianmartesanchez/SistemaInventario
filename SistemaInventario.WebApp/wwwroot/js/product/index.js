                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                var html = '<span >' +
                                    '<a href="/Product/Detalle/' + data + '" ><i class="zmdi zmdi-eye zmdi-hc-lg"></i></a>';

                               
                                html += '<a href="/Product/Edit/' + data + '"><i class="zmdi zmdi-edit zmdi-hc-lg"></i></a>';
